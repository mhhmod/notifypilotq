...
export const publicEnv = {
  appUrl: process.env.NEXT_PUBLIC_APP_URL ?? "https://notify.lnnsy.com",
...
export const serverEnv = {
  ...
  vapidSubject: process.env.VAPID_SUBJECT ?? "mailto:admin@sn2studios.co",
  ...
  shopifyRedirectUri:
    ...
    `${process.env.NEXT_PUBLIC_APP_URL ?? "https://notify.lnnsy.com"}/api/shopify/oauth/callback`,
